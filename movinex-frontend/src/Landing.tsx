...
const phoneSpecs: Record<string, Specs> = {
  ...
  'samsung-s24': {
    ...
    seguridad: 'Lector de huella ultrasónico en pantalla + reconocimiento facial',
  ...
  'iphone-15pro': {
    pantalla: '6.7" Super Retina XDR OLED (2796×1290), 120 Hz ProMotion, Always-On',
    procesador: 'A17 Pro (hexa-core con GPU de 6 núcleos)',
    ramAlmacenamiento: '8 GB RAM / 256 GB Almacenamiento',
    microSD: 'No',
    camaraTrasera: '48 MP principal + 12 MP ultra gran angular + 12 MP teleobjetivo 5x',
  ...
  'xiaomi-redmi13': {
    pantalla: '6.67" AMOLED CrystalRes FHD+ (2712×1220), 120 Hz, Gorilla Glass Victus',
...
export const Landing: React.FC<LandingProps> = ({ onSelectPhone, onNavigateAdmin }) => {
  ...
  const slides = [
    {
      ...
      subtitle: 'Estrena con solo 15% de enganche y paga por semana. Sin tarjeta, sin buró. Solo tu INE.'
    },
    {
      image: banner2,
      title: 'Solo con tu INE',
      subtitle: 'Te aprobamos con tu pura identificación. Estrena con 15% de enganche. Sin buró, sin tarjeta.'
    },
    {
      image: banner3,
      title: 'A tu ritmo',
      ...
      <header className={styles.header}>
        <div className={styles.headerContent}>
          ...
          <nav className={styles.nav}>
            ...
            {/* <button onClick={onNavigateAdmin} className={styles.adminBtn}>Backoffice</button> */}
          </nav>
        </div>
      </header>
          ...
          <section className={styles.heroCarousel}>
            <div className={styles.slidesContainer}>
              {slides.map((slide, index) => (
                ...
                >
                  <img src={slide.image} alt={slide.title} className={styles.slideBgImage} />
                  <div className={styles.slideContent}>
                    <h1>{slide.title}</h1>
                    <p>{slide.subtitle}</p>
                    <button onClick={() => setPage('tienda')} className={styles.ctaButtonWixSlide}>Cotizar</button>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section className={styles.foldDoubleCards}>
            <div className={styles.doubleCardsGrid}>
              <div
                ...
                style={{ backgroundImage: `linear-gradient(to right, rgba(11, 27, 60, 0.92) 0%, rgba(11, 27, 60, 0.5) 60%, rgba(11,27,60,0.2) 100%), url(${imgCardIne})` }}
              >
                <div className={styles.sideCardContent}>
                  <span className={styles.eyebrow}>Solo con tu INE</span>
                  <h2>Sin buró, sin tarjeta</h2>
                  <p>Te aprobamos con tu pura identificación. Estrena con 15% de enganche.</p>
                  <button onClick={() => setPage('tienda')} className={styles.ctaButtonSide}>Cotizar</button>
                </div>
              </div>
              <div
                className={styles.sideCard}
                style={{ backgroundImage: `linear-gradient(to right, rgba(11, 27, 60, 0.92) 0%, rgba(11, 27, 60, 0.5) 60%, rgba(11,27,60,0.2) 100%), url(${imgCardRitmo})` }}
              >
                <div className={styles.sideCardContent}>
            ...
            <div className={styles.badgesHorizontalRow}>
              <div className={styles.badgeCol}>
                <div className={styles.badgeIconBox}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" width="28" height="28" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className={styles.badgeCol} style={{ justifyContent: 'flex-end' }}>
                <div className={styles.badgeTextContent} style={{ textAlign: 'right' }}>
                  <h4>Págalo a tu ritmo</h4>
                  <p>Pagos chiquitos cada semana.</p>
                </div>
                <div className={styles.badgeIconBox} style={{ marginLeft: '16px' }}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" width="28" height="28" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className={styles.medidaGrid}>
              <div className={styles.medidaLeft}>
                <div className={styles.stackedPhonesContainer}>
                  <img src={imgFoldEnganche} alt="Los mejores celulares" className={styles.stackedImg} />
              ...
              <div className={styles.medidaRight}>
                ...
                <p>Marcas de calidad que cambiaran tu vida, sin complicaciones y con pagos accesibles.</p>
                <small className={styles.medidaTcs}>Aplican los términos y condiciones</small>
              </div>
            </div>
            <div className={styles.marcasGridSection}>
              <h3 className={styles.marcasSectionTitle}>Marcas</h3>
              <div className={styles.marcasGrid}>
                <div className={styles.marcaItem}><img src={marca1} alt="Samsung" /></div>
                <div className={styles.marcaItem}><img src={marca2} alt="Xiaomi" /></div>
                <div className={styles.marcaItem}><img src={marca3} alt="Honor" /></div>
                <div className={styles.marcaItem}><img src={marca4} alt="Motorola" /></div>
                <div className={styles.marcaItem}><img src={marca5} alt="Realme" /></div>
              </div>
            </div>
          </section>
          ...
          <section className={styles.foldDudasWix}>
            <div className={styles.dudasWixGrid}>
              ...
              <div className={styles.dudasImgCol}>
                <img src={imgFoldDudas} alt="Tienes dudas" className={styles.handImg} />
              </div>
            </div>
          </section>
        </>
      ...
      {page === 'movinex' && (
        <section className={styles.aboutSection}>
          <div className={styles.aboutContent}>
            ...
            <p>En Movinex creemos que tener un buen celular no debería depender de tener tarjeta de crédito.</p>
      ...
      {page === 'tienda' && (
        <section className={styles.tienda} style={{ marginTop: '40px' }}>
          <div className={styles.shopHeader}>
            ...
            <p className={styles.sectionSubtitle}>Los mejores celulares con financiamiento a tu medida. Estrena hoy mismo con 15% de enganche.</p>
          </div>
          <div className={styles.catalogo}>
            {loading ? (
              ...
              phones.map((phone, idx) => (
                <div key={phone.id} className={styles.productCard} onClick={() => handleQuickView(phone)}>
                  ...
                  <div className={styles.prodInfo}>
                    ...
                    <button className={styles.cotizarBtn} onClick={(e) => { e.stopPropagation(); onSelectPhone(phone); }}>Cotizar Ahora</button>
                  </div>
                </div>
              ))
            )}
      ...
      {selectedQuickView && (
        <div className={styles.modalOverlay} onClick={handleCloseQuickView}>
          <div className={styles.modalCard} onClick={(e) => e.stopPropagation()}>
            <button className={styles.closeBtn} onClick={handleCloseQuickView} aria-label="Cerrar modal">&times;</button>
            <div className={styles.modalGrid}>
              <div className={styles.modalLeft}>
                <div className={styles.modalImgWrap}>
                  <img src={selectedQuickView.imagen} alt={selectedQuickView.modelo} />
                </div>
                <div className={styles.modalFinanceCard}>
                  ...
                  <div className={styles.financeRow}>
                    ...
                    <strong style={{ color: '#2B6BE4' }}>${selectedQuickView.montoSemanal52}/sem</strong>
                  </div>
                  <p className={styles.financeNote}>Paga a 26 o 52 semanas sin tarjeta de crédito ni aval. Aprobación express con tu INE.</p>
                </div>
              </div>
              <div className={styles.modalRight}>
                <span className={styles.modalBrand}>{selectedQuickView.marca}</span>
                <h2 className={styles.modalTitle}>{selectedQuickView.modelo}</h2>
                <div className={styles.priceContainer}>
                  {selectedQuickView.id === 'samsung-a07' ? (
                    ...
                    <span className={styles.offerPrice}>${selectedQuickView.precioBase.toLocaleString()}</span>
                  )}
                </div>
                ...
                <div className={styles.modalActions}>
                  <button className={styles.solicitarBtn} onClick={() => handleProcederCotizar(selectedQuickView)}>Solicitar Crédito Ahora</button>
                  <button className={styles.cancelarBtn} onClick={handleCloseQuickView}>Volver a la tienda</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.footerColumn}>
            <div className={styles.socialsWix}>
              <a href="#" className={styles.socialIconLink}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.75z"/></svg>
              </a>
              <a href="#" className={styles.socialIconLink}>
              ...
              <a href="#" className={styles.socialIconLink}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12.525.02c1.31-.03 2.625-.01 3.935-.002.08.73.53 1.34 1.18 1.7 1.05.6 2.25.72 3.42.74v3.52c-.8-.01-1.61-.16-2.39-.37a4.9 4.9 0 01-2.21-1.34v7.7c-.02 2.11-.93 4.14-2.58 5.43a6.83 6.83 0 01-7.85.62A6.87 6.87 0 013.1 12.7c.07-2.92 2.14-5.59 5.04-6.07a6.9 6.9 0 016.14 2.13c.01-.84.004-1.68.006-2.52C12.18 5.6 10 5.03 8.35 6.07c-2.35 1.5-3.3 4.67-2.18 7.23a6.85 6.85 0 007.82 4.1c1.86-.54 3.16-2.3 3.16-4.24V.02z"/></svg>
              </a>
            </div>
          </div>
          <div className={styles.footerColumn}>
            ...
            <div className={styles.footerLinks}>
              <button onClick={() => setPage('inicio')} className={styles.footerBtnLink}>Inicio</button>
              <button onClick={() => setPage('movinex')} className={styles.footerBtnLink}>Movinex</button>
              <button onClick={() => setPage('tienda')} className={styles.footerBtnLink}>Tienda</button>
            </div>
          </div>
          <div className={styles.footerColumn}>
            <h4>Atención al cliente</h4>
            <div className={styles.footerLinks}>
              <a href="https://wa.me/525555028744?text=Hola%20Movinex" target="_blank" rel="noopener noreferrer">Contáctanos</a>
              <button onClick={() => setPage('movinex')} className={styles.footerBtnLink}>Acerca de</button>
            </div>
          </div>
          <div className={styles.footerColumn}>
            <h4>Política</h4>
        ...
        <div className={styles.footerPaymentSection}>
          ...
          <div className={styles.metodosPagoWix}>
            <div className={styles.paymentLogoWix}>
              <svg viewBox="0 0 24 15" width="40" height="25"><path d="M10.155 1.026L7.744 12.064h2.247l2.411-11.038zM18.665 1.026l-1.748 7.828-.75-3.957c-.443-1.503-1.802-3.136-3.376-3.871h.063l3.076 11.038h2.381l3.541-11.038zM2.87 1.026C1.229 2.052.483 3.328.483 4.887c0 2.213 2.508 2.656 2.508 3.738 0 .426-.452.802-1.424.802-.924 0-1.722-.38-2.312-.662l-.427 1.968c.613.279 1.636.533 2.7.533 2.378 0 3.916-1.127 3.916-2.873 0-2.353-2.516-2.73-2.516-3.882 0-.352.368-.69 1.258-.69.761 0 1.488.243 1.936.438l.424-1.954C6.182 1.979 5.097 1.706 2.87 1.026M13.626 1.026c-.52 0-.964.298-1.168.784L8.98 12.064h2.359l.47-1.295h2.884l.272 1.295h2.079zM12.441 8.94l1.171-3.218.675 3.218z" fill="#1A1F71"/></svg>
            </div>
            <div className={styles.paymentLogoWix}>
              <svg viewBox="0 0 24 15" width="40" height="25"><circle cx="8" cy="7.5" r="6" fill="#EB001B" opacity="0.9"/><circle cx="16" cy="7.5" r="6" fill="#F79E1B" opacity="0.9"/><path d="M12 3.8a6 6 0 0 1 2.2 3.7A6 6 0 0 1 12 11.2a6 6 0 0 1-2.2-3.7A6 6 0 0 1 12 3.8z" fill="#FF5F00"/></svg>
            </div>
            <div className={styles.paymentLogoWix}>
              <svg viewBox="0 0 24 15" width="40" height="25" style={{ borderRadius: '2px' }}><rect width="24" height="15" fill="#0070CD"/><text x="50%" y="60%" fill="#FFFFFF" fontSize="6.5" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">AMEX</text></svg>
            </div>
